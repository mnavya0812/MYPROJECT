...
Item
{
    ...
    Rectangle
    {
        ...
        Text
        {
            ...
            text: "MEDIA SETTINGS" ; font.family: "Lucida Calligraphy"; fontSizeMode: Text.Fit; font.pixelSize: 48
        }
    }
    ...
    {
        id: settingsList
        ListElement { name: "MEDIA SELECT" }
        ListElement { name: "MEDIA INFO" }
        ListElement { name: "FORMAT" }
    }
